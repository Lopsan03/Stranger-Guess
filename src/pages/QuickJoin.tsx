  ...
  return (
    <div className="min-h-screen bg-[#050508] flex items-center justify-center p-6 text-center">
      <div className="space-y-6">
        ...
        <p className="text-white/80">Joining room: <span className="text-white font-bold tracking-widest">{roomCode}</span></p>
        <div className="animate-pulse text-white/80 font-display text-xl uppercase tracking-widest">Loading Game...</div>
      </div>
